...
def test__make_tick_positions_min_max_equal() -> None:
    ...
    ticks = axis.Ticks(min_data=1, max_data=4, max_ticks=10)
    assert ticks._make_tick_positions(min_data=10, max_data=10, max_ticks=20) == [10.0]
...
def test__make_tick_positions(
    ...
    """It creates ticks."""
    ticks = axis.Ticks(min_data=1, max_data=4, max_ticks=10)
    assert ticks._make_tick_positions(
...
def test__make_tick_labels(
    ...
    axis_ticks = axis.Ticks(min_data=1, max_data=4, max_ticks=10)
